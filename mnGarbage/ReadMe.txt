...
========================================================================
    DYNAMIC LINK LIBRARY: mnGarbage-Projektübersicht
========================================================================

Diese mnGarbage-DLL wurde vom Anwendungs-Assistenten für 
Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre mnGarbage-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "mnGarbage.pch und eine 
