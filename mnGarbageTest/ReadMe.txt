...
========================================================================
    KONSOLENANWENDUNG: mnGarbageTest-Projektübersicht
========================================================================

Diese mnGarbageTest-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre mnGarbageTest-Anwendung besteht.


mnGarbageTest.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "mnGarbageTest.pch und eine 
